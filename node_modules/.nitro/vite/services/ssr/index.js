...
//#endregion
//#region src/lib/mongo.ts
var uri = process.env.MONGODB_URI || "mongodb://localhost:27017";
var dbName = process.env.MONGODB_DB || "lumen";
var cachedClient = null;
var cachedDb = null;
async function getDb() {
	if (cachedDb) return cachedDb;
	if (!cachedClient) cachedClient = new MongoClient(uri);
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./assets/server-aAiukK2l.js").then((m) => m.default ?? m);
